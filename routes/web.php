...
/*
Il faut ajouter un middleware role pour spécifier le user et l'admin. 
Il faut ensuite modifier le fichier kernel.blade.php en ajoutant role comme middleware
Ecrire une fonction dans le middleware Role. php artisan make:seeder UsersTableSeeder (pour créer un seeder
qui permet de donner des droits aux users).
*/
...
// Pour proteger la page admin, on a modifié la page RedirectifAuthenticated.php
Route::get('/admin/login', [AdminController::class, 'AdminLogin'])->middleware(RedirectIfAuthenticated::class)->name('admin.login');
Route::get('/backend/logout/page', [AdminController::class, 'AdminLogoutPage'])->name('admin.logout.page');
...
Route::middleware(['auth','role:admin'])->group(function() {
    ...
    // Route pour récupérer la sous categorie associée à la catégorie. A partir de add_news_post(js)
        Route::get('/subcategory/ajax/{category_id}','GetSubCategory');
    // Il faut ajouter dans le projet composer require intervention/image(pour redimensionné les img)
