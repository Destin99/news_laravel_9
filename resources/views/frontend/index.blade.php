...
<a href=""> {{ GoogleTranslate::trans($three->news_title, app()->getLocale() ) }}
 </a>
</h5>
</div>
</div>
...
<a href=" " class="tab-icon"><i class="la la-play"></i></a>
<h4 class="tab_hadding"><a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}">
  {{ GoogleTranslate::trans($item->news_title, app()->getLocale() ) }}</a></h4>
</div>
@endforeach
...
{{ GoogleTranslate::trans($category->category_name, app()->getLocale() )  }} </div>
</li> 
@endforeach
...
<div class="row">
<div class="col-lg-6 col-md-6">
<div class="themesBazar_widget"> <div class="textwidget"><p><img loading="lazy" class="aligncenter size-full wp-image-74" src="{{ asset($banner->home_tree) }}" alt="" width="100%" height="auto"></p>
</div>
</div> </div>
<div class="col-lg-6 col-md-6">
<div class="themesBazar_widget"> <div class="textwidget"><p><img loading="lazy" class="aligncenter size-full wp-image-74" src="" alt="{{ asset($banner->home_four) }}" width="100%" height="auto"></p>
</div>
</div> </div>
</div>
</div>
